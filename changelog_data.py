EREN_CHANGELOG = [
    {
        ...
        "changes": [
            ...
            "Hands-free mode - after E.R.E.N finishes a reply it automatically starts listening again, so you can keep talking without tapping the mic (tap the mic once more to stop)",
...
CHANGELOG = [
    {
        ...
        "changes": [
            ...
            "New Flowcharts lesson (Fundamentals) with a video tutorial and a quiz - learn the standard symbols: oval = start/end, rectangle = process, diamond = decision, parallelogram = input/output",
